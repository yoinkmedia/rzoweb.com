<div id="show" style="margin-left: 24px;height:650px;">
    ...
    <div style="float:left;margin-top:30px;margin-left:30px;">
    	...
    	<iframe src="//player.vimeo.com/video/<?php echo get_post_meta($postID, "video_id", true) ?>?badge=0" width="640" height="390" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
    	<div id="infos">
