...
$posts = get_posts(array('category'=>'27,6,8,25,24,28,7,5,26,3,22,23,21,4,1191,1195,1192,1194,1196,1197,1198,1190','numberposts'=>9));
?>
<div style="display:none;" id="current_page_popup"><?php echo $current_page; ?></div>
<div>
	<img src="<?php bloginfo('template_directory'); ?>/images/popup/this_show_off.png" style="margin-right:5px;cursor:pointer;" onclick="loadThisShowEpisodes('<?php bloginfo('url'); ?>','<?php echo $cat_id; ?>')" alt="" />
...
<div id="old_ep_nav_popup">
	<div id="prev" <?php if($of!=1): ?>onclick="reloadEpisodesListPopup('prev',<?php echo $current_page_popup; ?>,'<?php bloginfo('url'); ?>');"<?php endif; ?>><img src="<?php bloginfo('template_directory'); ?>/images/widget/shows/btn_prev.png" alt="" /></div>
	...
	<div id="next" <?php if($of!=1): ?>onclick="reloadEpisodesListPopup('next',<?php echo $current_page_popup; ?>,'<?php bloginfo('url'); ?>');"<?php endif; ?>><img src="<?php bloginfo('template_directory'); ?>/images/widget/shows/btn_next.png" alt="" /></div>
</div>