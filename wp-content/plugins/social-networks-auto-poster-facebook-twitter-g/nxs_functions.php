...
if (!function_exists('nxs_getPostImage')){ function nxs_getPostImage($postID, $size='large', $def='') { 
  /*
  $imgURL = '';  
  ...
  $cats= wp_get_post_categories($postID);
	if(in_array(27,$cats)){$img='3bieres';}
    elseif(in_array(6,$cats)){$img='boulbrutal';}
    elseif(in_array(8,$cats)){$img='frf';}
    elseif(in_array(25,$cats)){$img='horreur';}
    elseif(in_array(24,$cats)){$img='epee';}
    elseif(in_array(28,$cats)){$img='geekeurs';}
    elseif(in_array(7,$cats)){$img='lsdp';}
    elseif(in_array(5,$cats)){$img='dernierpodcasts';}
    elseif(in_array(26,$cats)){$img='shack';}
    elseif(in_array(3,$cats)){$img='mysterieux';}
    elseif(in_array(22,$cats)){$img='macquebec';}
    elseif(in_array(23,$cats)){$img='objnumerique';}
    elseif(in_array(21,$cats)){$img='podprobleme';}
    elseif(in_array(4,$cats)){$img='retronouveau';}
	elseif(in_array(1191,$cats)){$img='alcojeux';}
    elseif(in_array(1195,$cats)){$img='rais';}
    elseif(in_array(1192,$cats)){$img='geekorama';}
    elseif(in_array(1194,$cats)){$img='jouelejeu';}
    elseif(in_array(1196,$cats)){$img='e4c';}
    elseif(in_array(1197,$cats)){$img='pointdevues';}
    elseif(in_array(1198,$cats)){$img='souperdefilles';}
    elseif(in_array(1190,$cats)){$img='testeuralpha';}

	$imgURL = 'http://www.rzoweb.com/images_facebook/' . $img . '.jpg';
